...
async function solveChallenge(url,tab) {
    ...
    let languages = await tab.$$(".hackdown-content h3");// $$ double dollar is used for multiple values fetch like in array
    // above selector used to fetch array of headings 
